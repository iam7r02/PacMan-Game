...
public class PacMan extends JPanel implements ActionListener, KeyListener {
    ...
    private final long cherrySpawnInterval = 15000; 
    private long lastCherrySpawn = 0;
    ...
    public void draw(Graphics g){
        ...
        if (gameOver){
            if (isWin) {
                g.drawString("WIN! Score: "+ String.valueOf(score), tileSize/2, tileSize/2);
    ...
    public void move() {
        ...
        for (Block ghost : ghosts) {
            ...
            if (cherry == null && now - lastCherrySpawn >= cherrySpawnInterval){
                spawnCherry();
                lastCherrySpawn = now;
            }
            ...
            if (cherry != null && now - cherrySpawnTime >= cherryDuration) {
                cherry = null;
            }
        }
    ...
    public void spawnCherry() {
        ...
        Block foodSpot = foodArray[index];

        Image selectedImage = random.nextBoolean() ? cherryImage1 : cherryImage2;

        cherry = new Block(selectedImage, foodSpot.x - 14, foodSpot.y - 14, tileSize, tileSize);
